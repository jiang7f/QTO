...
from qto.solvers.qiskit import (
    ...
    QtoSimplifyDiscardSegmentedSolver,BitFlipNoiseAerProvider,NoiseDDsimProvider,
...
def process_layer(prb, num_layers, solver,p, pkid, pbid):
    ...
    aer = NoiseDDsimProvider(p_gate1 = p)
    ...
    print(f'time takes{perf_counter()-start} s for case {solver.__name__,p, pkid, pbid}')
    return result
