...
from qto.solvers.qiskit import (
    HeaSolver, PenaltySolver, CyclicSolver, ChocoSolver, ChocoSegmentedSolver,NoiseDDsimProvider,
    QtoSolver, QtoSimplifySolver, QtoSimplifyDiscardSolver, QtoSimplifyDiscardSegmentedCustomSolver, QtoSimplifyDiscardSegmentedFilterSolver,
    AerProvider, AerGpuProvider, DdsimProvider, FakeBrisbaneProvider, FakeKyivProvider, FakeTorinoProvider, DepolarizingNoiseAerProvider
)
...
solvers = [QtoSimplifyDiscardSegmentedCustomSolver]
...
def process_layer(prb, num_layers, solver):
    opt = CobylaOptimizer(max_iter=300,tol=None)
    aer = DdsimProvider()
    # aer = NoiseDDsimProvider(p_gate1 = 2.5e-4)
