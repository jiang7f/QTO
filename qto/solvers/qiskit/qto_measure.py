...
class QtoMeasureCircuit(QiskitCircuit[ChCircuitOption]):
...
class QtoMeasureSolver(Solver):
    ...
    def circuit(self):
        if self._circuit is None:
            self._circuit = QtoMeasureCircuit(self.circuit_option, self.model_option)
