...
from .circuit.circuit_components import obj_compnt, new_compnt_with_measure
from .qto_search import QtoSearchSolver

class QtoSimplifyDiscardCollapseCircuit(QiskitCircuit[ChCircuitOption]):
...
class QtoSimplifyDiscardCollapseSolver(Solver):
    def __init__(
        self,
        *,
        prb_model: LcboModel,
    ...
    def circuit(self):
        if self._circuit is None:
            self._circuit = QtoSimplifyDiscardCollapseCircuit(self.circuit_option, self.model_option)
